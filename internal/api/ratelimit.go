...
// pruneEvery is how many Allow calls pass between sweeps of the two maps.
...
// prune drops every IP whose block has expired and whose attempts have all aged out of the window.
