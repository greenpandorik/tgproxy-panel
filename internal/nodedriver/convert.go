...
func HealthFromProto(h *agentv1.HealthReport) HealthReport {
	out := HealthReport{
		...
		CPUUtilisationPercent: h.CpuUtilisationPercent, LoadAverage1: h.LoadAverage_1,
		LoadAverage5: h.LoadAverage_5, LoadAverage15: h.LoadAverage_15,
...
func HealthToProto(h HealthReport) *agentv1.HealthReport {
	out := &agentv1.HealthReport{
		...
		LoadAverage_5: h.LoadAverage5, LoadAverage_15: h.LoadAverage15,
