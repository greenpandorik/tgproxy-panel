...
| `TELEMT_VERSION` | The telemt release telemt nodes install (default `3.5.5`). A three-part version like `3.5.5`; it is interpolated into a root-run script. |
