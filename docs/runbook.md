...
Everything below applies to nodes created with the `telemt` engine (`GET /api/v1/nodes/{id}` shows `engine`). The upstream research this is based on: [`docs/research/2026-09-06-telemt-and-meko.md`](research/2026-09-06-telemt-and-meko.md).
